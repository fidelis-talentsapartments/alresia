...
const values = [
  {
    ...
    description: "Your success is our success. We align every decision with your business goals.",
  },
  {
    icon: Award,
    title: "Excellence",
    description: "We don't ship anything we wouldn't be proud to put our name on.",
  },
  {
    icon: Users,
    title: "Transparency",
  ...
  },
  {
    icon: Heart,
    title: "Partnership",
    description: "We're not just vendors—we're your technical partners for the long haul.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  We set out to build something different—a development partner that 
                  treats transparency as a feature, not an afterthought. Every project 
                  gets a dedicated dashboard, every milestone is tracked, and AI helps 
                  us plan smarter from day one.
                </p>
                <p>
                  Today, we're proud to serve clients from startups to Fortune 500 
                  companies, delivering software that actually ships on time and on budget.
                </p>
              </div>
            </div>
