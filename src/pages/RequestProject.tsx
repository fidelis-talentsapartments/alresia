          ...
          <div className="container mx-auto px-4">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-8">
                Thank you for your interest in working with DevForge. Our team will 
                review your project requirements and reach out within 24 hours with 
                an AI-generated project scope and next steps.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Tell us about your project and we'll provide an AI-generated scope, 
              timeline, and tech recommendations within 24 hours.
            </p>
          </div>
        </div>
      </section>
              ...
              {step === 2 && (
                <div className="space-y-6 animate-fade-up">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      The more details you provide, the better our AI can scope your project.
                    </p>
                  </div>
